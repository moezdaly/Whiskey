...
print('##############################')
print('this is my first model with inceptionv3 and 2 hidden layers (corrected the trainable weights for good results)')
print('##############################')
...
print('##############################')
print('this is my first model with inceptionv3 and 3 hidden layers (corrected the trainable weights for good results)')
print('##############################')
...
print('##############################')
print('this is my first model with inceptionv3 TEST(corrected the trainable weights for good results)')
print('##############################')
